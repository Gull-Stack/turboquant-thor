...
_CENTROIDS: dict[int, list[float]] = {
    ...
    5: [
        -3.1827647198979756, -2.6024102209294173,
        -2.2223248089880094, -1.929250618060309,
        -1.6859397115431496, -1.4752126853563916,
        -1.2876135800849746, -1.1173052495557005,
        -0.9603659084623373, -0.813973096617495,
        -0.6759710421043363, -0.5446233656117615,
        -0.4184633416469501, -0.2961989741361471,
        -0.17665034991993545, -0.0587064554521585,
        0.0587064554521585, 0.17665034991993545,
        0.2961989741361471, 0.4184633416469501,
        0.5446233656117615, 0.6759710421043363,
        0.813973096617495, 0.9603659084623373,
        1.1173052495557005, 1.2876135800849746,
        1.4752126853563916, 1.6859397115431496,
        1.929250618060309, 2.2223248089880094,
        2.6024102209294173, 3.1827647198979756,
    ],
}
...
def get_codebook_unscaled(bits: int) -> tuple[mx.array, mx.array]:
    ...
    if bits not in _CENTROIDS:
        raise ValueError(f"Supported bits: 1, 2, 3, 4, 5. Got: {bits}")
